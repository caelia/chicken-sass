...
(define (make-options )
  ((foreign-lambda (struct "Sass_Options*") sass_make_options (void)) ))
...
(define (context-get-options )
  ((foreign-lambda (struct "Sass_Options*") sass_context_get_options (struct Sass_Context* ctx)) ))
; struct Sass_Options* sass_context_get_options (struct Sass_Context* ctx);
(define (file-context-get-options )
  ((foreign-lambda (struct "Sass_Options*") sass_file_context_get_options (struct Sass_File_Context* file_ctx)) ))
; struct Sass_Options* sass_file_context_get_options (struct Sass_File_Context* file_ctx);
(define (data-context-get-options )
  ((foreign-lambda (struct "Sass_Options*") sass_data_context_get_options (struct Sass_Data_Context* data_ctx)) ))
; struct Sass_Options* sass_data_context_get_options (struct Sass_Data_Context* data_ctx);
(define (file-context-set-options )
  ((foreign-lambda void sass_file_context_set_options (struct Sass_File_Context* file_ctx, struct Sass_Options* opt)) ))
...
(define (data-context-set-options )
  ((foreign-lambda void sass_data_context_set_options (struct Sass_Data_Context* data_ctx, struct Sass_Options* opt)) ))
...
(define (option-set-source-comments )
  ((foreign-lambda void sass_option_set_source_comments (struct Sass_Options* options, bool source_comments)) ))
; void sass_option_set_source_comments (struct Sass_Options* options, bool source_comments);
(define (option-set-source-map-embed )
  ((foreign-lambda void sass_option_set_source_map_embed (struct Sass_Options* options, bool source_map_embed)) ))
...
(define (option-set-source-map-contents )
  ((foreign-lambda void sass_option_set_source_map_contents (struct Sass_Options* options, bool source_map_contents)) ))
...
(define (option-set-omit-source-map-url )
  ((foreign-lambda void sass_option_set_omit_source_map_url (struct Sass_Options* options, bool omit_source_map_url)) ))
...
(define (option-set-is-indented-syntax-src )
  ((foreign-lambda void sass_option_set_is_indented_syntax_src (struct Sass_Options* options, bool is_indented_syntax_src)) ))
...
(define (option-set-indent )
  ((foreign-lambda void sass_option_set_indent (struct Sass_Options* options, const char* indent)) ))
; void sass_option_set_indent (struct Sass_Options* options, const char* indent);
(define (option-set-linefeed )
  ((foreign-lambda void sass_option_set_linefeed (struct Sass_Options* options, const char* linefeed)) ))
; void sass_option_set_linefeed (struct Sass_Options* options, const char* linefeed);
(define (option-set-input-path )
  ((foreign-lambda void sass_option_set_input_path (struct Sass_Options* options, const char* input_path)) ))
; void sass_option_set_input_path (struct Sass_Options* options, const char* input_path);
(define (option-set-output-path )
  ((foreign-lambda void sass_option_set_output_path (struct Sass_Options* options, const char* output_path)) ))
; void sass_option_set_output_path (struct Sass_Options* options, const char* output_path);
(define (option-set-plugin-path )
  ((foreign-lambda void sass_option_set_plugin_path (struct Sass_Options* options, const char* plugin_path)) ))
; void sass_option_set_plugin_path (struct Sass_Options* options, const char* plugin_path);
(define (option-set-include-path )
  ((foreign-lambda void sass_option_set_include_path (struct Sass_Options* options, const char* include_path)) ))
; void sass_option_set_include_path (struct Sass_Options* options, const char* include_path);
(define (option-set-source-map-file )
  ((foreign-lambda void sass_option_set_source_map_file (struct Sass_Options* options, const char* source_map_file)) ))
...
(define (option-set-source-map-root )
  ((foreign-lambda void sass_option_set_source_map_root (struct Sass_Options* options, const char* source_map_root)) ))
; void sass_option_set_source_map_root (struct Sass_Options* options, const char* source_map_root);
(define (option-set-c-headers )
  ((foreign-lambda void sass_option_set_c_headers (struct Sass_Options* options, Sass_Importer_List c_headers)) ))
; void sass_option_set_c_headers (struct Sass_Options* options, Sass_Importer_List c_headers);
(define (option-set-c-importers )
  ((foreign-lambda void sass_option_set_c_importers (struct Sass_Options* options, Sass_Importer_List c_importers)) ))
; void sass_option_set_c_importers (struct Sass_Options* options, Sass_Importer_List c_importers);
(define (option-set-c-functions )
  ((foreign-lambda void sass_option_set_c_functions (struct Sass_Options* options, Sass_Function_List c_functions)) ))
...
(define (compiler-get-state )
  ((foreign-lambda (enum "Sass_Compiler_State") sass_compiler_get_state(struct Sass_Compiler* compiler)) ))
...
(define (option-push-plugin-path )
  ((foreign-lambda void sass_option_push_plugin_path (struct Sass_Options* options, const char* path)) ))
; void sass_option_push_plugin_path (struct Sass_Options* options, const char* path);
(define (option-push-include-path )
  ((foreign-lambda void sass_option_push_include_path (struct Sass_Options* options, const char* path)) ))
