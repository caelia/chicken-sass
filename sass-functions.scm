...
(define (make-importer-list )
  ((foreign-lambda Sass_Importer_List "sass_make_importer_list" (size_t length)) ))
; Sass_Importer_List sass_make_importer_list (size_t length);
(define (importer-get-list-entry )
  ((foreign-lambda Sass_Importer_Entry "sass_importer_get_list_entry" (Sass_Importer_List list, size_t idx)) ))
; Sass_Importer_Entry sass_importer_get_list_entry (Sass_Importer_List list, size_t idx);
(define (importer-set-list-entry )
  ((foreign-lambda void "sass_importer_set_list_entry" (Sass_Importer_List list, size_t idx, Sass_Importer_Entry entry)) ))
...
(define (make-importer )
  ((foreign-lambda Sass_Importer_Entry "sass_make_importer" (Sass_Importer_Fn importer, double priority, void* cookie)) ))
...
(define (importer-get-function )
  ((foreign-lambda Sass_Importer_Fn "sass_importer_get_function" (Sass_Importer_Entry cb)) ))
; Sass_Importer_Fn sass_importer_get_function (Sass_Importer_Entry cb);
(define (importer-get-priority )
  ((foreign-lambda double "sass_importer_get_priority" (Sass_Importer_Entry cb)) ))
; double sass_importer_get_priority (Sass_Importer_Entry cb);
(define (importer-get-cookie )
  ((foreign-lambda void* "sass_importer_get_cookie" (Sass_Importer_Entry cb)) ))
; void* sass_importer_get_cookie (Sass_Importer_Entry cb);

;;; Deallocator for associated memory
(define (delete-importer )
  ((foreign-lambda void "sass_delete_importer" (Sass_Importer_Entry cb)) ))
